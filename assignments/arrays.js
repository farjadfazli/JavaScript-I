...
let sortedInventory = inventory.sort((a,b) => a.car_model.localeCompare(b.car_model));
let carModels = sortedInventory.map(({car_model}) => car_model);
let logCarModels = () => {
...
// Alternative method:
// let carModelsAlphabetical = [];
// for (let i=0; i<inventory.length; i++) {
//     carModelsAlphabetical.push(inventory[i]['car_model'])
// };
// carModelsAlphabetical.sort();
// console.log(carModelsAlphabetical);
